...
<%
	...
	Cookie cookie=new Cookie("food"+no,no); // 쿠키 생성 (숫자만 X)
	cookie.setMaxAge(60*60*24); // 기간 설정 -> 하루
	response.addCookie(cookie); // 클라이언트(브라우저)에 보내줌
%>
 		...
 		<div class="row">
 			<div class="col-md-8">
 				<table class="table">
 					...
 					%>
 							<td class="text-center"><img src="<%=st.nextToken() %>" width="100%"></td>
 					<%
 						}
 					%>
 					</tr>
