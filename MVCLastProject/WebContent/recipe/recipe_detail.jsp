...
<div class="wrapper row2">
  <div id="services" class="clear"> 
    ...
    <div class="row">
      <c:if test="${count!=0 }">
    	<div class="thumbnail">
	        <img src="${vo.poster }" alt="Lights" style="width: 800px; height: 400px;">
	        <div class="caption">
	          <p class="text-center"><img src="${vo.chef_poster }" style="width: 100px; height: 100px;" class="img-circle"></p>
	    ...
	    <table class="table">
	    	...
	    	<tr>
	    		<td width="30%" class="text-center" rowspan="2">
	    			<img src="${vo.chef_poster }" style="width: 60px; height: 60px;" class="img-circle">
	    		</td>
