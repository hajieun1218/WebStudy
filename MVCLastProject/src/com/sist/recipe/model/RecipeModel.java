...
public class RecipeModel {
	...
	public String recipe_chef_detail(HttpServletRequest request, HttpServletResponse response) {
		...
		// request.setCharacterEncoding("UTF-8"); ==> post방식에서
		// get방식은 server.xml => URIEncoding="UTF-8"
	...
	public String recipe_recipe_find(HttpServletRequest request, HttpServletResponse response) {
		String[] data={
				"전체","밑반찬","메인반찬","국/탕","찌개",
		...
		List<String> nList=Arrays.asList(data); // 배열을 list로 바꿀때
