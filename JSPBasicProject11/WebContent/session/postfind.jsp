...
function ok(zip,addr) {
	opener.frm.post1.value=zip.substring(0,3); //opener: join.jsp
	...
	<div class="container">
		...
		<div class="row">
			...
			<table class="table">
				<tr>
					<td>
						<!-- value: 자바에서 받았기때문에 자바에서 출력(맨처음에는 null값이므로 null값이면 공백) 
							우편번호 검색 후 검색한 내용 유지하려면 value값 사용해야함-->
